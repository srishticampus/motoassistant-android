...
import com.project.motoassistant.UserProductOrderHistoryDetails;
...
public class UserProductOrderHistoryAdapter extends RecyclerView.Adapter<UserProductOrderHistoryAdapter.MyViewHolder> {

    Root root;
    Context context;


    public UserProductOrderHistoryAdapter(Root root, Context context) {
        this.root = root;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_layout_user_product_order_history, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, UserProductOrderHistoryDetails.class);
